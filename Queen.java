public class Queen extends Piece {
    ...
    public boolean isValidMove(int[] end, Piece[][] board) {
      ...
      int rowMovement = 1;
      if (x == super.getRow()) { // basically we are going to simulate moving on the board and returning false if there is anything between the destination
        rowMovement = 0;
      ...
      return (board[x][y] == null || board[x][y].getColor() != getColor()); // trying to check if the piece is free or if the destination is a piece of the opposite color
  }
}
